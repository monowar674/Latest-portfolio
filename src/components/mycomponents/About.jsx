...
const About = ({ setmanue }) => {
  return (
    <div className='w-full h-full items-center flex transition duration-300 flex-col justify-center '>
      <div className=" relative  w-[80%] lg:w-1/2 h-[60%] px-2 rounded-2xl bg-[#0011ac] grid grid-cols-1 lg:grid-cols-2 gap-3 items-center justify-center">
        {/* <h1 className='text-white absolute px-2 py-1 top-0 left-0 bg-amber-200 text-3xl font-extrabold'>About Us</h1> */}
        <div className="w-10 h-10 flex items-center justify-center rounded-full border-2 border-black bg-[#061ad4] absolute -top-5 left-1/2">
          <RxCross2 size={30} fill='#fff' className='  cursor-pointer pointer-events-auto' onClick={() => setmanue(false)} />

        </div>
        <div className="w-full">
          <Image className='w-full  h-[220px] mb-4 object-cover rounded-2xl' src={img} alt='' />
          <div className="flex gap-2 items-center justify-between  mt-4">
            ...
            <div className='relative group pointer-events-auto transition-all duration-300 ease-in-out items-center justify-center flex'>
              ...
              <IoLogoCss3 size={35} fill='#3d61ad' />
            </div>
            <div className='relative group pointer-events-auto transition-all duration-300 ease-in-out items-center justify-center flex'>
              ...
              <IoLogoJavascript size={35} fill='#e8d44d' />
            </div>
            <div className='relative group pointer-events-auto transition-all duration-300 ease-in-out items-center justify-center flex'>
            ...
            <div className='relative group pointer-events-auto transition-all duration-300 ease-in-out items-center justify-center flex'>
              ...
              <RiNextjsFill size={35} fill='#17181b' />
            </div>
            <div className='relative group pointer-events-auto transition-all duration-300 ease-in-out items-center justify-center flex'>
              ...
              <FaBootstrap size={35} fill='#7d0af8' />
            </div>
            <div className='relative group pointer-events-auto transition-all duration-300 ease-in-out items-center justify-center flex'>
              ...
              <RiTailwindCssFill size={35} fill='#3d61ad' />
            </div>
          </div>
        </div>
        <div className=" w-full h-[80%]">
          <h2 className='text-xl md:text-2xl lg:text-3xl text-center text-[#ff5100] font-extrabold'>About Me</h2>
          <p className='text-white text-lg font-medium'>Hii..! Iam MD.Monowar Hossain. Iam a Front-End Web Devoloper. And I Have Completed My Diploma in Engineering Computer Scince From Jhenaidha pilytecnic insttitude. </p>
